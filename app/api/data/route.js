...
export async function GET() {
  const [clientes, vehiculos, insumos, kits, ordenes, detalles, movimientos] = await Promise.all([
  ...
  const resultados = { clientes, vehiculos, insumos, kits, ordenes, detalles, movimientos };
